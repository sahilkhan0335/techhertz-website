...
const NodeButton = ({ isCompleted, onClick, title, children }: NodeButtonProps) => {
  return (
    <motion.button
      className={`w-16 h-16 xs:w-20 xs:h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 xl:w-36 xl:h-36 rounded-full backdrop-blur-lg border-2 flex items-center justify-center transition-all duration-700 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-lg ${
        isCompleted
